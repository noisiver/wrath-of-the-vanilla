...
class instance_onyxias_lair_vanilla : public InstanceMapScript
{
    public:
        instance_onyxias_lair_vanilla() : InstanceMapScript("instance_onyxias_lair", 249) {}
...
void AddSC_instance_onyxias_lair_vanilla()
{
    new instance_onyxias_lair_vanilla();
