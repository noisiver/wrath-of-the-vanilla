...
class boss_onyxia_vanilla : public CreatureScript
{
    public:
        boss_onyxia_vanilla() : CreatureScript("boss_onyxia") {}

        struct boss_onyxiaAI_vanilla : public BossAI
        {
        public:
            boss_onyxiaAI_vanilla(Creature* pCreature) : BossAI(pCreature, DATA_ONYXIA)
            {
                Initialize();
            }
        ...
        {
            return GetOnyxiasLairAI<boss_onyxiaAI_vanilla>(creature);
        };
};

void AddSC_boss_onyxia_vanilla()
{
    new boss_onyxia_vanilla();
}
